/*
 * 8x8 basic ASCII bitmap font
 * Source: dhepper/font8x8, Public Domain
...
/* ASCII 0x20 (space) through 0x7F, one byte per row, bit 0 is the left pixel */
static const uint8_t ST7735_FONT8X8_BASIC[96][8] = {
